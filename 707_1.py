...
Instruction context:
 ...
 L.  16        70  LOAD_GLOBAL              str
                  72  LOAD_FAST                'e'
                  74  CALL_FUNCTION_1       1  '1 positional argument'
                  76  LOAD_METHOD              encode
                  78  LOAD_STR                 'utf-8'
...
class VulnerableCatchError(catch_error.CatchError):
    ...
    def __call__Parse error at or near `POP_BLOCK' instruction at offset 86
