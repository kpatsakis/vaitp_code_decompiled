...
Instruction context:
 ...
 L.  16        12  LOAD_FAST                'self'
                  14  LOAD_METHOD              on_message_activity
                  16  LOAD_FAST                'turn_context'
                  18  CALL_METHOD_1         1  '1 positional argument'
                  20  GET_AWAITABLE    
                  22  LOAD_CONST               None
                  24  YIELD_FROM       
                  26  POP_TOP          
                  28  JUMP_FORWARD         30  'to 30'
->              30_0  COME_FROM            28  '28'
...
class MyBot(ActivityHandler):
    ...
    async def on_turnParse error at or near `COME_FROM' instruction at offset 30_0
