...
Instruction context:
 ...
 L.  11        38  LOAD_STR                 'error'
                  40  LOAD_GLOBAL              str
                  42  LOAD_FAST                'e'
                  44  CALL_FUNCTION_1       1  '1 positional argument'
                  46  LOAD_CONST               ('status', 'message')
                  48  BUILD_CONST_KEY_MAP_2     2 
                  50  ROT_FOUR         
->                52  POP_BLOCK        
                  54  POP_EXCEPT       
                  56  CALL_FINALLY         60  'to 60'
                  58  RETURN_VALUE     
                60_0  COME_FROM            56  '56'
                60_1  COME_FROM_FINALLY    36  '36'
                  60  LOAD_CONST               None
                  62  STORE_FAST               'e'
                  64  DELETE_FAST              'e'
                  66  END_FINALLY      
...
def api_callParse error at or near `POP_BLOCK' instruction at offset 52
