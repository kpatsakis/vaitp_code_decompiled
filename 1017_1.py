...
Instruction context:
 ...
 L.  12        46  LOAD_FAST                'session_data'
                  48  POP_BLOCK        
->                50  ROT_TWO          
                  52  BEGIN_FINALLY    
                  ...
                  58  POP_FINALLY           0  ''
                  60  RETURN_VALUE     
                62_0  COME_FROM_WITH       34  '34'
                  62  WITH_CLEANUP_START
                  64  WITH_CLEANUP_FINISH
                  66  END_FINALLY      
                  68  JUMP_FORWARD         74  'to 74'
                70_0  COME_FROM            24  '24'
import os, mod_python

def load_sessionParse error at or near `ROT_TWO' instruction at offset 50
